        ...
        return (
            <section className="task-details">
                ...
                <div className="details-opts">
                    <div className="opt-select" onClick={() => this.setChosenOpt('updates')}>Updates</div>
                    <div className="opt-select" onClick={() => this.setChosenOpt('info-boxes')}>Info Boxes</div>
                    <div className="opt-select" onClick={() => this.setChosenOpt('activity-log')}>Activity Log</div>
